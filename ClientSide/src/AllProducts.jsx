    ...
    return (
        <div className='main-container'>
            ...
            <div className="image-grid">
                <ImageGrid category="kofia" images={images.kofia} showDeleteModal={showDeleteModal} />
                <ImageGrid category="pensi" images={images.pensi} showDeleteModal={showDeleteModal} />
                <ImageGrid category="tshirt" images={images.tshirt} showDeleteModal={showDeleteModal} />
                <ImageGrid category="sweta" images={images.sweta} showDeleteModal={showDeleteModal} />
                <ImageGrid category="tracks" images={images.tracks} showDeleteModal={showDeleteModal} />
            </div>
                ...
                <div className="modal-wrapper">
                    <div className="modal">
                        <div className="modal-content">
                            <h3 style={{color: 'black'}}>INGIZA NAMBA YA SIMU</h3>
                            <input
                                type="text"
                                value={phoneNumber}
                            ...
                            <button onClick={() => setShowModal(false)} style={{backgroundColor: 'red'}}>Cancel</button>
                        </div>
                    </div>
                </div>
            )}
